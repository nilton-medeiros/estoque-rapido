...
def show_products_grid(page: ft.Page):
    ...
    async def handle_action_click(e):
        ...
        match action:
            ...
            case "EDIT":
                ...
                page.go('/home/produtos/form')
            case "SOFT_DELETE":
                is_deleted = pro_actions.send_to_trash(page=page, produto=produto)
                if is_deleted:
    ...
    async def load_data_and_update_ui():
        ...
        try:
            ...
            logger.error(f"Ocorreu um erro ao carregar as produtos de produtos. Tipo: {type(e).__name__}, Erro: {e}\nTraceback:\n{tb_str}")
