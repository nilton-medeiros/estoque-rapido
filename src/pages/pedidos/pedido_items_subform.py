...
class PedidoItemsSubform:
    ...
    def __init__(self, page: ft.Page, app_colors: dict, on_items_change=None):
        self.page = page
        ...
        self.next_item_id = 1  # ID incremental para novos itens
    ...
    def _add_item(self, e):
        ...
        item = {
            ...
            'quantity': float(self.new_item_quantity.value),
            'unit_price': float(self.new_item_unit_price.value.replace(',', '.')),
    ...
    def set_items(self, items: list[dict]):
        ...
        self.next_item_id = max([item.get('id', 0) for item in self.items], default=0) + 1
        self._update_items_display()
        self._update_total()
    ...
    def get_total_products(self) -> int:
        """Retorna o número total de produtos diferentes"""
