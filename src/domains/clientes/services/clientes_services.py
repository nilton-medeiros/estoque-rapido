...
class ClientesServices:
    ...
    def create(self, cliente: Cliente, current_user: Usuario) -> str | None:
        """
        Cria um novo cliente no repositório de clientes.

        Args:
            cliente (Cliente): Objeto Cliente contendo os dados do cliente a ser criado.
            current_user (dict): Dicionário contendo informações do usuário logado.
    ...
    def update(self, cliente: Cliente, current_user: Usuario) -> str | None:
        """
